...
| Parameters     	| #1.  The string from which to create the substring (<-- two spaces) #2.  The start index of the substring in the string ’s’. #3.  The maximum length of the    substring. |
